...
params:
  ...
  decoy_psms_ef: ~/git/elfragmentador-data/mokapot/phospho.mokapot.decoy.psms.txt
  decoy_psms: ~/git/elfragmentador-data/mokapot/phospho.mokapot.psms.txt
  psms_ef: ~/git/elfragmentador-data/mokapot/phospho.mokapot.psms.txt
  psms: ~/git/elfragmentador-data/mokapot/phospho.mokapot.decoy.psms.txt
...
ggplot(pin_df, aes(x = NormRTSqError, fill = factor(Label))) +
  geom_histogram(alpha = 0.7, shape = ".") +
  facet_wrap(~Label, ncol = 1) + scale_y_sqrt() +
  scale_y_sqrt()
